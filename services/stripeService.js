...
async function createCheckoutSession(userId, orderItems, orderId) {
    ...
    const session = await stripe.checkout.sessions.create({
        ...
        mode: 'payment',
        success_url: "https://5173-fauroni-assessment-2tn5i07s01x.ws-us118.gitpod.io/success_payment",
        cancel_url:"https://5173-fauroni-assessment-2tn5i07s01x.ws-us118.gitpod.io/cancelled_payment",
